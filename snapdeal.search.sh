...
function searchWoohoo()
{
    ...
    if [ $? -eq 0 ]; then
        date
	/root/node/node-v5.6.0-linux-x64/bin/node /root/scraper/notification.cmd.js custom 25722518 'Snapdeal woohoo' 'Snapdeal woohoo available at discount' 'https://www.snapdeal.com/product/woohoo-egift-card/641543859318'
        exit 0
    fi
}
